  ...
  <div class='row g-0'>
    ...
    <div class='col-md-8'>
      <div class='card-body'>
        ...
        <p class='card-text'><small class='text-muted'><a href='products/details.php?id=". $row['media_id'] ."'><button class='btn text-white btn-sm' type='button' style='background:#D0B8A8'  >Read more</button></a></small></p>
...
<header>
        ...
        <h2 class="card-title ">Our recommendations for you</h2>
    </header>
